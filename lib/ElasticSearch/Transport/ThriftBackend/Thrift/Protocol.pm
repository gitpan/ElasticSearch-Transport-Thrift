...
# @param int $type message type ElasticSearch::Transport::ThriftBackend::TMessageType::CALL or ElasticSearch::Transport::ThriftBackend::TMessageType::REPLY
...
# causing corruption.
#
# @param ElasticSearch::Transport::ThriftBackend::TType $type What type is it
#
sub skip
{
    my $self = shift;
    ...
    if($type == ElasticSearch::Transport::ThriftBackend::TType::BOOL)
    {
        return $self->readBool(\$ref);
    }
    elsif($type == ElasticSearch::Transport::ThriftBackend::TType::BYTE){
        return $self->readByte(\$ref);
    }
    elsif($type == ElasticSearch::Transport::ThriftBackend::TType::I16){
        return $self->readI16(\$ref);
    }
    elsif($type == ElasticSearch::Transport::ThriftBackend::TType::I32){
        return $self->readI32(\$ref);
    }
    elsif($type == ElasticSearch::Transport::ThriftBackend::TType::I64){
        return $self->readI64(\$ref);
    }
    elsif($type == ElasticSearch::Transport::ThriftBackend::TType::DOUBLE){
        return $self->readDouble(\$ref);
    }
    elsif($type == ElasticSearch::Transport::ThriftBackend::TType::STRING)
    {
        return $self->readString(\$ref);
    }
    elsif($type == ElasticSearch::Transport::ThriftBackend::TType::STRUCT)
    {
    ...
    elsif($type == ElasticSearch::Transport::ThriftBackend::TType::MAP)
    {
        my($keyType,$valType,$size);
    ...
    elsif($type == ElasticSearch::Transport::ThriftBackend::TType::SET)
    {
        my ($elemType,$size);
    ...
    elsif($type == ElasticSearch::Transport::ThriftBackend::TType::LIST)
    {
        my ($elemType,$size);
    ...
    die new ElasticSearch::Transport::ThriftBackend::Thrift::TException("Type $type not recognised --- corrupt data?");
...
sub skipBinary
{
    ...
    elsif($type == ElasticSearch::Transport::ThriftBackend::TType::SET || $type == ElasticSearch::Transport::ThriftBackend::TType::LIST)
    {
        # Vtype
        my $data = $itrans->readAll(1);
        my @arr = unpack('c', $data);
...
ElasticSearch::Transport::ThriftBackend::TProtocolException
