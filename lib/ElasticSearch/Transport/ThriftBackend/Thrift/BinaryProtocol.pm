...
use ElasticSearch::Transport::ThriftBackend::Thrift::Protocol;
...
{
    my $self = shift;
    return $self->writeByte(ElasticSearch::Transport::ThriftBackend::TType::STOP);
}
...
sub readMessageBegin
{
    ...
    if (($version & VERSION_MASK) > 0) {
      if (($version & VERSION_MASK) != VERSION_1) {
        die new ElasticSearch::Transport::ThriftBackend::Thrift::TException('Missing version identifier')
      }
...
sub readFieldBegin
{
    ...
    if ($$fieldType == ElasticSearch::Transport::ThriftBackend::TType::STOP) {
      $$fieldId = 0;
      return $result;
    }
...
sub getProtocol{
    ...
    return new ElasticSearch::Transport::ThriftBackend::Thrift::BinaryProtocol($trans);
}
